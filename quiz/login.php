...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $auth->loginTeam($username, $password);
...
<head>
    ...
    <title>PABSON Inter School Quiz Competition - Team Login</title>
    ...
    <div class="login-card">
        ...
        <div class="login-body">
            ...
            <div class="admin-link">
                <p>Are you an admin? <a href="<?php echo APP_URL; ?>/admin/login.php">Login here</a></p>
            </div>
        </div>
    </div>
</body>
